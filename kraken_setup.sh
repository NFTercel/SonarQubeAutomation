...
if read -p "What is your password? " pass; then
...
echo "Running Plan"
echo "Changes have not been applied (debugging)." # docker run --rm kraken --apply --development --username=${name} --local-tf-vars=../target_workspace/terraform_desktop.tfvars
