...
echo "3. Run these scripts from your local or dev (VIO) machines."
echo "4. SSH to your new instance and add the hostname to your /etc/hosts file ( 127.0.0.1	{hostname} ) (cat /etc/hostname for your hostname)."
